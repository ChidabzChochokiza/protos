...
func (x *RegisterRequerst) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterRequerst) ProtoMessage() {}

func (x *RegisterRequerst) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use RegisterRequerst.ProtoReflect.Descriptor instead.
func (*RegisterRequerst) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{0}
}

func (x *RegisterRequerst) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *RegisterRequerst) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x04Auth\x12:\n" +
	"\bRegister\x12\x16.auth.RegisterRequerst\x1a\x16.auth.RegisterResponse\x120\n" +
...
var file_sso_sso_proto_goTypes = []any{
	(*RegisterRequerst)(nil), // 0: auth.RegisterRequerst
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequerst
